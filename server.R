      ...
      observeEvent( input$btn_build_commodity_report_ex,
                    {
                       ...
                       if(tmp_execution_pre_define){
                          ...
                          insertUI(
                             ...
                             ui =   div( id = 'body_ci_markets_ex_map',
                                         fluidRow(h2( HTML(paste0(textOutput("H2_map_of_export_title"))) ) ,
                                                  ...
                                                  highchartOutput('MapEXMarket') %>% withSpinner(type=4) )
                             )
                          )
                          ## end Try UI insert --------##
                          ...
                          ## XXXX: Hide generating report message (report generation for NZ export to world)  ----------
                          #observe({
                           #  if( any(input$select_comodity_ex_for_market_analysis %in% tmp_tab$Name)   ){
                                #Sys.sleep(2)
                          ...
                          ## XXXX:  Stop and Ask if to proceed Global Trade anlaysis on the selected commodity ---------------------
                           
                          observeEvent(
                             req(input$select_comodity_ex_for_market_analysis),
                             {
                                insertUI(
                                   selector = '#body_ci_markets_ex',
                                   ui =   div( id = 'body_ci_markets_btn_ask_global_analysis',
                                               tags$hr(),
                                               tags$h3( "Click on the 'Run global analysis' button to display global supply and demand information for the selected commodity. It could take up to 30 seconds." ),
                                               actionButton("btn_global_analysis_ex_pre", 
                                                            "Run global analysis",
                          ...
                          ## XXXX: build run globla anaylisi button -----------
                          observeEvent( input$btn_global_analysis_ex_pre,
                                        {
                                           ## disable the buttone ---
                                           shinyjs::hide("body_ci_markets_btn_ask_global_analysis")
                                           #removeUI( selector = "#body_ci_markets_btn_ask_global_analysis" )
                                           
                                           ## disable selector  ---
                                           shinyjs::disable("select_comodity_ex_for_market_analysis")
                                           
                                           ## hide the button  ---
                                           #shinyjs::hide("body_ci_markets_btn_ask_global_analysis")
                                           
                                           ## insert waiting message ---
                                           insertUI(
                                              selector = '#body_ci_markets_ex',
                                              ui = div( id = "waiting_message_global_analysis_pre",
                                                        tags$hr(),
                                                        tags$h1("Running global analysis...", align = "center") )
                                           )
                                           ...
                                           insertUI(
                                              ...
                                              ui =   div( id = 'body_ci_markets_ex_global_facts',
                                                          fluidRow(
                                                             ...
                                                             infoBoxOutput("Un_comtrade_world_market_size_pre_define") %>% withSpinner(4),
                                           ...
                                           ### remove wating message -----
                                           #Sys.sleep(2)
                                           removeUI( selector = "#waiting_message_global_analysis_pre" )
                                        }
                          )
                          ...
                          ## XXXX: hide waite message (First message ) ----
