   ...
   fluidRow(
      ...
      tags$ol(
         ...
         tags$li( "Search or select ONLY ONE of the market groups. We prebuilt several groups including ", 
                  ...
                  tags$a(href="ttps://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/digital-economy-partnership-agreement-depa/","FTA in force - DEPA" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/pacer-plus/","FTA in force - PACER Plus" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-china-free-trade-agreement/","FTA in force - NZ-China FTA" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-australia-closer-economic-relations-cer/","FTA in force - NZ-Australia CER" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/asean-australia-new-zealand-free-trade-agreement-aanzfta/","FTA in force - AANZFTA" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-hong-kong-china-closer-economic-partnership/","FTA in force - NZ-Hong Kong CEP" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-malaysia-free-trade-agreement/","FTA in force - NZ-Malaysia FTA" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-singapore-closer-economic-partnership/","FTA in force - NZ-Singapore CEP" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/nz-thailand-closer-economic-partnership/","FTA in force - NZ-Thailand CEP" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/trans-pacific-strategic-economic-partnership-p4/","FTA in force - P4" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/korea-new-zealand-free-trade-agreement/","FTA in force - NZ-Korea FTA" , target = "_blank"), ", ",  
                  tags$a(href="https://www.mfat.govt.nz/en/trade/free-trade-agreements/free-trade-agreements-in-force/cptpp/","FTA in force - CPTPP" , target = "_blank"), ", ",  
                  ...
                  tags$a( href = "https://github.com/weizhang18/nz_trade_dashboard/issues", "Github"), ', if you need extra groups built.' ),
         tags$li(tags$b("Please click RESET before generating an other report!")),
         tags$li( "For more detailed explanations on how to use this part of the dasbhoard, please visit " ,
                  tags$a( "here",
                          href= "https://nzprimarysectortrade.wordpress.com/2018/10/15/introducing-the-new-zealand-trade-intelligence-dashboard/",
